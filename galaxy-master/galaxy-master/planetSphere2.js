...
planetSphere2.create = function() {
	var obj = new Object();
	
	obj.position = vec3.create([0,0,0]);
	
	obj.collision = collisionMesh.create();
	obj.collision.addSphere(0,0,0, 5000, 3000);
	...
	obj.shader = hglCreateProgram(shaderPlanetSphere2Vertex, shaderPlanetSphere2Fragment);
...
var shaderPlanetSphere2Fragment = 
